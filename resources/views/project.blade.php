...
*/
    ...
    <h3 id="toc_3">服务端代码</h3>

    <ul>
        <li>框架 Laravel 5.7</li>
        <li>使用到的特性 </li>
    </ul>

    <blockquote>
        <p>表格下面有代码示例，摘自于项目源码。</p>
    </blockquote>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="text-align: center">消息通知</td>
            <td style="text-align: center">被其他人关注时消息通知</td>
        </tr>
        <tr>
            <td style="text-align: center">Policy</td>
            <td style="text-align: center">用户授权</td>
            <td style="text-align: center">只有自己才能编辑自己发布的问题</td>
        </tr>
        <tr>
            <td style="text-align: center">Request</td>
            <td style="text-align: center">自定义验证</td>
            <td style="text-align: center">发布问题时验证字段的规则以及返回的错误提示</td>
        </tr>
        <tr>
            <td style="text-align: center">Collection</td>
            <td style="text-align: center">集合</td>
            <td style="text-align: center">对数据进行处理</td>
        </tr>
        <tr>
            <td style="text-align: center">Eloquent ORM</td>
            <td style="text-align: center">关系模型</td>
            <td style="text-align: center"></td>
        </tr>
        <tr>
            <td style="text-align: center">-</td>
            <td style="text-align: center">API 资源：Resource</td>
            <td style="text-align: center">对API返回数据进行处理</td>
        </tr>
        <tr>
            <td style="text-align: center">-</td>
            <td style="text-align: center">模型关联/多态关联</td>
            <td style="text-align: center">代替部分Join功能</td>
        </tr>
        <tr>
            <td style="text-align: center">-</td>
            <td style="text-align: center">修改器/访问器</td>
            <td style="text-align: center">插入/查看数据时，对数据进行预处理</td>
        </tr>
        <tr>
            <td style="text-align: center">Passport</td>
            <td style="text-align: center">用户认证</td>
            <td style="text-align: center">实现OAuth2.0 对API接口的访问进行认证</td>
        </tr>
        </tbody>
    </table>

    <ul>
        <li><p>消息通知：Notification </p>

            <pre><code>//发送私信后 给用户一个提示
class SendMessageNotification extends Notification
{
    ...
    ...
            ...
            <pre><code>class MessageRepository
{
    ...
            ...
            <pre><code>class QuestionsController extends Controller
{
    ...
    */
    ...
    ...
        ...
        <li><p>Repository模式 使数据库操作与控制器分离</p>
...
public function store(QuestionRequest $request)
{
    ...
    return redirect(route(&#39;questions.index&#39;));
        ...
        <li><p>关系模型：Eloquent ORM</p>

            <ul>
                <li><p>API资源：Resource 对接口返回的数据进行处理</p>

                    <pre><code>class TopicResource extends JsonResource
{
        ...
        return [
            ...
            &#39;text&#39; =&gt; $this-&gt;name,
                ...
                <li><p>模型关联/多态关联</p>
                    ...
                    <pre><code>class Comments extends Model
{
    ...
    public function user()
    {
        ...
        <li><p>Passport认证 实现OAuth2.0</p></li>
        <li><p>扩展包</p></li>
    </ul>
    ...
    <table>
        <thead>
        <tr>
            <th style="text-align: center">扩展包名称</th>
            <th style="text-align: center">描述</th>
            <th style="text-align: center">应用场景</th>
        </tr>
        </thead>
        ...
        <tbody>
        <tr>
            <td style="text-align: center">laracasts/flash</td>
            <td style="text-align: center">消息提示</td>
            <td style="text-align: center">登录后浏览器上方可以看到</td>
        </tr>
        <tr>
            <td style="text-align: center">laravel/passport</td>
            <td style="text-align: center">身份验证</td>
            <td style="text-align: center">实现OAuth2.0  url: /my/passport</td>
        </tr>
        <tr>
            <td style="text-align: center">naux/sendcloud</td>
            <td style="text-align: center">邮件发送</td>
            <td style="text-align: center">注册邮箱验证及密码找回</td>
        </tr>
        <tr>
            <td style="text-align: center">overtrue/laravel-ueditor</td>
            <td style="text-align: center">编辑器</td>
            <td style="text-align: center">提问页面可查看</td>
        </tr>
        <tr>
            <td style="text-align: center">predis/predis</td>
            <td style="text-align: center">Redis扩展</td>
            <td style="text-align: center">缓存了提问数据</td>
        </tr>
        </tbody>
    </table>
    ...
    <ul>
        <li><p>框架</p>
            ...
            <ul>
                <li>Vue.js 主要使用了vue-component 做了 关注用户 关注问题等组件</li>
                <li>Blade 模板</li>
            </ul></li>
        <li><p>扩展包</p>

            <ul>
                <li>Select2 提问页面-话题</li>
                <li>Axios 处理HTTP请求</li>
                <li>Laravel mix 编译前端文件</li>
                <li>Vue-image-crop-upload 图片裁剪上传</li>
                <li>Bootstrap 4 页面部署 </li>
            </ul></li>
    </ul>
