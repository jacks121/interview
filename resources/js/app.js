...
Vue.component('send-message-button', require('./components/SendMessageButton.vue').default);
Vue.component('comments-form', require('./components/CommentsForm.vue').default);
